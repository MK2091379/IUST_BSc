...
; 0000 002B a = a << 1;
	LSL  R10
; 0000 002C if(a==0) a= 1;
	TST  R10
	BRNE _0x3
	LDI  R30,LOW(1)
	MOV  R10,R30
; 0000 002D 
; 0000 002E   OnesSec=OnesSec+1;
_0x3:
	INC  R8
; 0000 002F   if(OnesSec % 2 != 0)
	RCALL SUBOPT_0x0
	BREQ _0x4
; 0000 0030   {
; 0000 0031         DP = 0x00;
...
; 0000 003A         OnesSec=0;
	CLR  R8
; 0000 003B         TensSec=TensSec+1;
	INC  R9
; 0000 003C   }
; 0000 003D   if(TensSec==6)
_0x6:
	LDI  R30,LOW(6)
	CP   R30,R9
	BRNE _0x7
...
; 0000 003F      TensSec=0;
	CLR  R9
; 0000 0040      OnesMin=OnesMin+1;
	INC  R6
; 0000 0041   }
; 0000 0042    if(OnesMin==10)
_0x7:
	LDI  R30,LOW(10)
	CP   R30,R6
	BRNE _0x8
...
; 0000 0045       OnesMin=0;
	CLR  R6
; 0000 0046       TensMin=TensMin+1;
	INC  R7
; 0000 0047    }
; 0000 0048    if( TensMin==6)
_0x8:
	LDI  R30,LOW(6)
	CP   R30,R7
	BRNE _0x9
...
; 0000 004A         TensMin=0;
	CLR  R7
; 0000 004B         OnesHour=OnesHour+1;
	INC  R4
; 0000 004C    }
; 0000 004D    if(OnesHour==10)
_0x9:
	LDI  R30,LOW(10)
	CP   R30,R4
	BRNE _0xA
; 0000 004E    {
; 0000 004F        OnesHour=0;
	CLR  R4
; 0000 0050        TensHour=TensHour+1;
	INC  R5
; 0000 0051    }
; 0000 0052    if(TensHour==2 && OnesHour==4)
_0xA:
	LDI  R30,LOW(2)
	CP   R30,R5
	BRNE _0xC
...
_0xD:
; 0000 0053    {
; 0000 0054         OnesHour=0;
	CLR  R4
; 0000 0055         TensHour=0;
	CLR  R5
; 0000 0056    }
; 0000 0057 
; 0000 0058 
...
; 0000 005B int ParseToHex(char x){
_ParseToHex:
; .FSTART _ParseToHex
; 0000 005C switch (x)
	ST   -Y,R26
...
; 0000 007D PORTB=(0<<PORTB7) | (0<<PORTB6) | (0<<PORTB5) | (0<<PORTB4) | (0<<PORTB3) | (0<<PORTB2) | (0<<PORTB1) | (0<<PORTB0);
	...
	OUT  0x18,R30
; 0000 007E 
; 0000 007F DDRC=(1<<DDC7) | (1<<DDC6) | (1<<DDC5) | (1<<DDC4) | (1<<DDC3) | (1<<DDC2) | (1<<DDC1) | (1<<DDC0);
	LDI  R30,LOW(255)
	OUT  0x14,R30
; 0000 0080 
...
; 0000 008B TCCR1A=(0<<COM1A1) | (0<<COM1A0) | (0<<COM1B1) | (0<<COM1B0) | (0<<WGM11) | (0<<WGM10);
	OUT  0x2F,R30
; 0000 008C TCCR1B=(0<<ICNC1) | (0<<ICES1) | (0<<WGM13) | (1<<WGM12) | (1<<CS12) | (0<<CS11) | (0<<CS10);
	LDI  R30,LOW(12)
	OUT  0x2E,R30
...
; 0000 0090 ICR1L=0x00;
	OUT  0x26,R30
; 0000 0091 OCR1AH=0x7A;
	LDI  R30,LOW(122)
	OUT  0x2B,R30
; 0000 0092 OCR1AL=0x12;
	LDI  R30,LOW(18)
	OUT  0x2A,R30
...
; 0000 009A 
; 0000 009B 
; 0000 009C TIMSK=(0<<OCIE2) | (0<<TOIE2) | (0<<TICIE1) | (1<<OCIE1A) | (0<<OCIE1B) | (0<<TOIE1) | (0<<OCIE0) | (0<<TOIE0);
	LDI  R30,LOW(16)
	OUT  0x39,R30
; 0000 009D 
...
; 0000 00A0 
; 0000 00A1 
; 0000 00A2 UCSRB=(0<<RXCIE) | (0<<TXCIE) | (0<<UDRIE) | (0<<RXEN) | (0<<TXEN) | (0<<UCSZ2) | (0<<RXB8) | (0<<TXB8);
	OUT  0xA,R30
; 0000 00A3 
; 0000 00A4 
...
; 0000 00B7       PORTD = 0b11111110;
	LDI  R30,LOW(254)
	OUT  0x12,R30
; 0000 00B8       PORTC = ParseToHex(TensHour);
	MOV  R26,R5
	RCALL SUBOPT_0x1
; 0000 00B9       delay_ms(7);
; 0000 00BA       PORTD = 0b11111101;
	LDI  R30,LOW(253)
	OUT  0x12,R30
; 0000 00BB       PORTC = ParseToHex(OnesHour) | DP;
	MOV  R26,R4
	RCALL SUBOPT_0x2
; 0000 00BC       delay_ms(7);
; 0000 00BD       PORTD = 0b11111011;
	LDI  R30,LOW(251)
	OUT  0x12,R30
; 0000 00BE       PORTC = ParseToHex(TensMin);
	MOV  R26,R7
	RCALL SUBOPT_0x1
; 0000 00BF       delay_ms(7);
; 0000 00C0       PORTD = 0b11110111;
	LDI  R30,LOW(247)
	OUT  0x12,R30
; 0000 00C1       PORTC = ParseToHex(OnesMin) | DP ;
	MOV  R26,R6
	RCALL SUBOPT_0x2
; 0000 00C2       delay_ms(7);
; 0000 00C3       PORTD = 0b11101111;
	LDI  R30,LOW(239)
	OUT  0x12,R30
; 0000 00C4       PORTC = ParseToHex(TensSec);
	MOV  R26,R9
	RCALL SUBOPT_0x1
; 0000 00C5       delay_ms(7);
; 0000 00C6       PORTD = 0b11011111;
	LDI  R30,LOW(223)
	OUT  0x12,R30
; 0000 00C7       PORTC = ParseToHex(OnesSec) | DP ;
	MOV  R26,R8
	RCALL SUBOPT_0x2
