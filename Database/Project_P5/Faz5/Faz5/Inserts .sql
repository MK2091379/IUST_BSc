 Insert Into Person (National_Code,First_Name, Last_Name ,phone, email ,Birthday ,Gender ,age )
...
Insert Into Person (National_Code,First_Name, Last_Name ,phone, email ,Birthday ,Gender ,age )
values ('1637743','Hasan','Abadi','09137726981','HassanAbadi77@gmail.com','1000-01-02',1,'29')

Insert Into Person (National_Code,First_Name, Last_Name ,phone, email ,Birthday ,Gender ,age )
values ('5337743','Ali','Sotoodeh','09163553981','Ali_sotoodeh76546@gmail.com','1000-01-02',1,'39')

Insert Into Person (National_Code,First_Name, Last_Name ,phone, email ,Birthday ,Gender ,age )
values ('306032781','Reza','Ghasemi','09135467981','RezaGH@gmail.com','1000-01-02',1,'28')

Insert into Seller( Seller_ID, Seller_Password , Shop_Name ,Adress ,Business_License ,Is_Online_Sale ,Contract_Type,Seller_point,Logo , Work_Start ,work_end,Communication ,Sale_Statistics ,National_Code )
values ('1','1234','Padoos','Khiyaban Emam','image','y','foroosh_online_offlin','90',null,'00:00:00.0000000','23:59:59.9999999',null,'500','3223233')

Insert into Seller( Seller_ID,Seller_Password , Shop_Name ,Adress ,Business_License ,Is_Online_Sale ,Contract_Type,Seller_point,Logo , Work_Start ,work_end,Communication ,Sale_Statistics ,National_Code )
values ('2','1234','Poshak Varzehi Mohammadi','Khiyaban Takhti','image','N','foroosh_offline','80',null,'00:00:00.0000000','23:59:59.9999999',null,'1002','663773')

Insert into Seller( Seller_ID,Seller_Password , Shop_Name ,Adress ,Business_License ,Is_Online_Sale ,Contract_Type,Seller_point,Logo , Work_Start ,work_end,Communication ,Sale_Statistics ,National_Code )
values ('3','1234','Poshak Arman','Khiyaban Ferdowsi','image','N','foroosh_offline','70',null,'00:00:00.0000000','23:59:59.9999999',null,'100','2234567')



Insert Into Product (Product_ID,Seller_ID, Barcode, Buyer_Point, Supply ,Price,  Color, Product_Name, Picture, Brand , Product_Type, Size, Material,  Guarantee,  Product_Info, Product_Weight)
...
Insert Into Comment(Comment_ID, Product_ID, Commentator_Name, Comment_Text)
...
Insert into Group_Manager(Group_Manager_id, Education, Contract_Type, Management_Location, Communication, National_Code )
values('1','masters of art','full time','Khiyaban Ferdowsi','091554699','3066663')

Insert into Group_Manager(Group_Manager_id, Education, Contract_Type, Management_Location, Communication, National_Code )
values('2','masters of Math','part time','Khiyaban Takhti','091624699','306032781')

Insert into Group_Manager(Group_Manager_id, Education, Contract_Type, Management_Location, Communication, National_Code )
values('3','masters of IT','full time','Khiyaban Emam','09164344699','22004567')

Insert into Employee( Employee_ID ,Education ,Contract_Type, Communication ,National_Code)
...
Insert into  Financial_Report(Report_Code,Number_OF_Images,Volume_OF_Images,Total_Price ,Report_Date ,Number_OF_Sales,Seller_ID )
...
Insert into Buyer(Buyer_Code,Buyer_Password, Account_Type ,Buyer_Point  ,Buys_Number, Adress,National_Code)
Values ('1','1234','free','30','20','Tajik st','3933232')

Insert into Buyer(Buyer_Code,Buyer_Password, Account_Type ,Buyer_Point  ,Buys_Number, Adress,National_Code)
Values ('2','1234','free','20','10','Takhti st','23300443')

Insert into Buyer(Buyer_Code,Buyer_Password, Account_Type ,Buyer_Point  ,Buys_Number, Adress,National_Code)
Values ('3','1234','premium','40','33','Shariati','6637743')
...
insert into Site_Manager(Site_Manager_Code,Education,Contract_Type,Communication,National_Code )
 values ('111','Diploma of Math','full time','434333444','5337743')
 
 insert into Buys(Buyer_Code,Product_ID)
 values('1','122')
  insert into Buys(Buyer_Code,Product_ID)
 values('1','123')
  insert into Buys(Buyer_Code,Product_ID)
